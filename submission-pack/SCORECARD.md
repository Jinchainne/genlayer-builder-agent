...
- Frontend / UX: The live site includes wallet connect, deploy, submit, respond, resolve, claim-release, and read-back flows, so the reviewer can verify the full app-to-contract lifecycle directly.